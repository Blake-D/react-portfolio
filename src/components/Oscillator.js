...
function Oscillator(){
    return(
        <div className="cube-div">
            ...
            <div className="about">
                <b class="two-d">Web Oscillator</b> is an online synthesizer written in Javascript, CSS, and HTML. The user can produce a drone of their choosing and manipulate its frequency and harmony by dragging the cursor across the page's X and Y axes.<br></br>
