    ...
    return(
        <div className="cube-div">
            ...
            <div className="about">
                ...
                <a className="cube-link" href="https://blake-d.github.io/ShowdownOnCygnus8/" target="_blank" rel="noreferrer">play game</a><br></br>
                <a className="cube-link" href="https://github.com/Blake-D/ShowdownOnCygnus8" target="_blank" rel="noreferrer">GitHub repo</a>
            </div>
        </div>
    )
}
