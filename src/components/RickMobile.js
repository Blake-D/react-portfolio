    ...
    return(
        <div className="cube-div">
            ...
            <div className="about">
                ...
                GitHub repo: <a className="cube-link" href="https://github.com/Blake-D/Rickipedia" target="_blank" rel="noreferrer">Front End</a> | <a className="cube-link" href="https://github.com/Blake-D/Mortiverse" target="_blank" rel="noreferrer">Back End</a><br></br><br></br>
            </div>
        </div>
    )
}
