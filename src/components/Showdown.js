...
function Showdown(){
    return(
        <div className="cube-div">
            ...
            <div className="about">
                <b class="two-d">Showdown on Cygnus 8</b> is a browser game written in Javascript, HTML, & CSS. As an intergalactic bounty hunter with a high-profile criminal in tow, you must survive a series of quickdraw matches in order to hang on to your bounty.<br></br>
